...
const baseInputStyles = "block w-full px-4 py-2 text-slate-900 placeholder-slate-400 bg-slate-50 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition";
                ...
                {data.educationHistory.map((entry) => (
                  <li key={entry.id} className="p-3 flex justify-between items-center bg-slate-50 hover:bg-slate-100">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <button type="button" onClick={() => handleEditHistory(entry, 'educationHistory')} className="text-blue-600 hover:text-blue-800 font-medium text-sm">Editar</button>
              ...
              <ul className="border border-slate-200 rounded-md divide-y divide-slate-200">
                {data.workExperience.map((entry) => (
                  <li key={entry.id} className="p-3 flex justify-between items-center bg-slate-50 hover:bg-slate-100">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <button type="button" onClick={() => handleEditHistory(entry, 'workExperience')} className="text-blue-600 hover:text-blue-800 font-medium text-sm">Editar</button>
              ...
              return (
                <>
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="currentJob" name="currentJob" checked={isCurrentJob} onChange={handleCurrentWorkToggle} className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
